...
🚀 Quick Guide:
[**🖥️Live Demo**](https://gitee.com/Destiny_cc/JieGerBlog) /
[**📝Documentation**](https://gitee.com/Destiny_cc/JieGerBlog) /
[**🍀Repository**](https://gitee.com/Destiny_cc/JieGerBlog)
...
>[!TIP]
>
>JieGerBlog is a fresh, beautiful, and modern personal blog theme template based on the Astro framework and the Fuwari template, designed for tech enthusiasts and content creators. It integrates a modern web tech stack, offering rich feature modules and a highly customizable interface so you can easily build a professional and visually appealing personal blog.
>
>**If you refer to or use Firefly component design and related code, please credit Firefly.**
>
>JieGerBlog also preserves the original fuwari layout, which can be freely switched in the configuration file according to your preferences.
>
>**For more layout configurations and demos, please see: [JieGerBlog Layout System Details](https://gitee.com/Destiny_cc/JieGerBlog)**
>
>JieGerBlog supports i18n multilingual UI, but except for Simplified Chinese, other languages are AI-translated. If you find any errors, feel free to submit a [Pull Request](https://github.com/lj874802276/JieGerBlog/pulls) to help improve them.
...
If you have useful features and optimizations, please submit a [Pull Request](https://github.com/lj874802276/JieGerBlog/pulls)
...
1. **Clone the repository:**
   ...
   **First [Fork](https://github.com/lj874802276/JieGerBlog/fork) to your own repository then clone (recommended). Don't forget to Star before Fork!**
...
> 📚 **Detailed Configuration Documentation**: Check [JieGerBlog Documentation](https://gitee.com/Destiny_cc/JieGerBlog) for complete configuration guide
...
Also supports [Memos](https://www.usememos.com/) as a data source. Configure the `memos` option in `src/config/dynamicConfig.ts` to fetch Memos moments in real-time, with pinned sync and image attachment support. See [Moments documentation](https://gitee.com/Destiny_cc/JieGerBlog).
...
- Admonitions - Supports configuration for GitHub, Obsidian, VitePress, and Docusaurus themes ([Preview and Usage](https://gitee.com/Destiny_cc/JieGerBlog))
- GitHub Repository Cards ([Preview and Usage](https://gitee.com/Destiny_cc/JieGerBlog))
- Enhanced Code Blocks based on Expressive Code ([Preview](https://gitee.com/Destiny_cc/JieGerBlog) / [Documentation](https://expressive-code.com/))
...
Thanks to the following contributors for their contributions to this project. If you have any questions or suggestions, please submit an [Issue](https://github.com/lj874802276/JieGerBlog/issues) or [Pull Request](https://github.com/lj874802276/JieGerBlog/pulls).
