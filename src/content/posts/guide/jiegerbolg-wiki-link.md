...
| 写法 | 示例 | 在 Obsidian 中 |
|---|---|---|
| frontmatter 的 `slug` | `[[jiegerbolg-wiki-link]]` | ✗ 不支持 |
| 文件路径（相对仓库根目录） | `[[guide/jiegerbolg-layout-system]]` | ✓ 需改设置（推荐） |
| 裸文件名（仓库内唯一时） | `[[jiegerbolg-layout-system]]` | ✓ 默认即是 |
...
[[guide/jiegerbolg-layout-system#相关链接|jiegerbolg-layout-system]]
