...
export const site = {
  name: "JieGerBlog",
  desc: "JieGerBlog 个人博客",
  url: "https://github.com/lj874802276/JieGerBlog",
  avatar: "/favicon/jiegerblog-192.png",
  email: "healwis@qq.com",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言/发送申请邮件至：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">healwis@qq.com</code></p>
